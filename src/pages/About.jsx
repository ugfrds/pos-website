  ...
  return (
    ...
    <NavBar headerColor={headerColor} color = {color} />
      ...
      <section className="how-it-works-section text-center">
        <h1>How It Works</h1>
        <p className="fw-medium fs-5 w-80 ">Our POS system integrates seamlessly into your business workflow, 
          allowing you to manage transactions, inventory, and reports all from one platform.</p>
        ...
        <div className="how-it-works-columns">
          ...
          <div className="how-it-works-item">
            ...
            <h4 className='fw-medium'>Step 3: Grow</h4>
      ...
      <section className="support-team-section">
        <h2 className="fw-bold fs-1 mb-4">Our Support Heroes</h2>
      ...
      <section className="testimonials-section">
        <h2 className="fw-bold fs-1 mb-4">What Our Clients Say</h2>
        <p className="fw-medium fs-5 ">See why businesses love using our POS system to manage their operations efficiently and effectively.</p>
